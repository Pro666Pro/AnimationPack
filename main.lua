...
game:GetService("StarterGui"):SetCore("SendNotification",{Title = "Loading...",Text = "Getting Animation Pack...",Icon = "rbxassetid://7733658504",Duration = 5})
wait(2)
game:GetService("StarterGui"):SetCore("SendNotification",{Title = "Loaded!",Text = "Successfully Got Animation Pack! Enjoy.",Icon = "rbxassetid://7733658504",Duration = 5})
